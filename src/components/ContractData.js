...
class ContractData extends Component {
  constructor(props, context) {
    ...
    //console.log(this.props.contract, ' ', this.props.method, ' ', 'ContractData context: ', context);
    //console.log(this.props.contract, ' ', this.props.method, ' ', 'ContractData this.contracts: ', this.contracts);
    ...
    //console.log(this.props.contract,  ' ', this.props.method, ' ', 'ContractData this.dataKey: ', this.dataKey);
  ...
  render() {
    ...
    //console.log(this.props.contract,  ' ', this.props.method, ' ', 'ContractData component displaydata: ', displayData);
    //console.log(this.props.contract,  ' ', this.props.method, ' ', 'displaydata data type: ', typeof displayData);
